      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          ...
          <div>
            ...
            <base-button class="btn-2" type="primary" icon="ni ni-bag-17" />
          ...
          <base-button class="btn-1" type="info">
            Info
          </base-button>
          <base-button class="btn-1" type="success">
            Success
          </base-button>
          <base-button class="btn-1" type="warning">
            Warning
          </base-button>
          <base-button class="btn-1" type="danger">
            Danger
          </base-button>
          <base-button class="btn-1" type="neutral">
            Neutral
          </base-button>
